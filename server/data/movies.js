// The starting list of movies used to fill (seed) the database.
// This is the same data that used to live in the frontend (src/data/movies.js).
// After seeding, the app reads movies from MongoDB instead of from this file.
